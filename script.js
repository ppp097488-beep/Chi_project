...
const resultData = {
    ...
    dalbo:{
        ...
        recommend:[
            {
                name: "우리 WON 적금",
                description: "목표 금액을 위해 꾸준히 저축하며 우대금리 혜택도 받을 수 있는 적금 상품입니다."
            },
            {
                name: "우리 슈퍼 정기예금",
                description: "안정적인 이자 수익을 원하는 고객에게 적합한 대표 정기예금 상품입니다."
            },
            {
                name: "채권형 펀드",
                description: "국채와 회사채 등에 투자하여 비교적 안정적인 수익을 추구하는 펀드입니다."
            }
        ],
